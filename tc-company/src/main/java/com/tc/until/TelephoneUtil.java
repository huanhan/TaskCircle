...
public class TelephoneUtil {
    /**
     * 是否将电话号码统一格式化为xxx-xxxx-xxx
     */
    public static boolean FormatTransfer = true;
    /**
     * 是否将电话号码统一格式化为xxx-xxxx-xxx
     */
    public static boolean MosaicSwtich = true;
    /**
     * 声明常量掩码，最大支持18位
     */
    public static final String MosaicMask = "*****************";
    /**
     * 几个常见的座机号码常见分隔符 /**
     */
    public static final String[] TelephoneSeparator = new String[] { "-", "\\(", "\\)", "（", "）", "转", "·" };
    ...
    public enum TelephoneType {
        Mobile("Mobile", "") {
            ...
            protected String format(String telePhoneNum) {
                ...
                if (!telePhoneNum.matches(telRegex)) {
