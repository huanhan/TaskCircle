...
public class SmsCodeAuthenticationSecurityConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain,HttpSecurity> {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        smsCodeAuthenticationFilter.setAuthenticationSuccessHandler(tcAuthenticationSuccessHandler);
        smsCodeAuthenticationFilter.setAuthenticationFailureHandler(tcAuthenticationFailureHandler);
